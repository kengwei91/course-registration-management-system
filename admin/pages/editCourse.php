...
$courseprice = $editrow['CoursePrice'];
                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="editCourse.php">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" name="course_price" value="<?php echo $courseprice; ?>">
									...
									<?php 
									if(isset($_POST["editcourse"])){
										if(!($_POST["course_name"]) Or !($_POST["course_price"]) Or !($_POST["course_desc"]))
										{
											...
											echo editCourse($courseid,$coursename,$courseprice,$coursedesc,$courselecturer,$coursesession,$coursehour);
										}
									}
									?>
