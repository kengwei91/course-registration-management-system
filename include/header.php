...
<head>
	...
	<meta name="description" content="All-IT-Academy-Asia-Template">
	<title>IT Academy Asia Malaysia</title>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">
					<img src="assets/images/logo.png" alt="IT Academy Asia template"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li><a href="viewclass.php"><span class='glyphicon glyphicon-calendar' aria-hidden='true'></span> My Session</a></li>
					<li><a href="svieworder.php"><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> My Requests</a></li>
					<li><a href="waitlist.php"><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> My Wait-List</a></li>
					<li class="dropdown">
